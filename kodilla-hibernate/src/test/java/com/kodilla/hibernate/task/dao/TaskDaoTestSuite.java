...
public class TaskDaoTestSuite {
    ...
    void testNamedQueries() {
        //Given
        Task task1 = new Task ("Test: study Hiberante", 3);
        ...
        TaskList taskList = new TaskList("To Do list", "The list of things to do");
        ...
        List<Task> tasksWithEnoughTime = taskDao.retrieveTasksWithEnoughTime();
        ...
        try {
            ...
            assertEquals(3, tasksWithEnoughTime.size());
